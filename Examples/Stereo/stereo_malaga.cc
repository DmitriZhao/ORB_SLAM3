...
int main(int argc, char **argv)
{
    if(argc < 4)
    {
        cerr << endl << "Usage: ./stereo_malaga path_to_vocabulary path_to_settings path_to_sequence (trajectory_file_name)" << endl;
        return 1;
    }
    ...
    ORB_SLAM3::System SLAM(pathToVocabulary, pathToSettings, ORB_SLAM3::System::STEREO, true);
